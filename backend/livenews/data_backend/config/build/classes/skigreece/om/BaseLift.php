...
/**
 * Base class that represents a row from the 'lift' table.
 *
 *
 *
 * @package    propel.generator.skigreece.om
 */
abstract class BaseLift extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
     ...
     * @return Lift The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LiftPeer::ID;
        }
    ...
    public function setname($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = LiftPeer::NAME;
        }
    ...
    public function setopen($v)
    {
        ...
        if ($this->open !== $v) {
            $this->open = $v;
            $this->modifiedColumns[] = LiftPeer::OPEN;
        }
    ...
    public function setskicenter_id($v)
    {
        ...
        if ($this->skicenter_id !== $v) {
            $this->skicenter_id = $v;
            $this->modifiedColumns[] = LiftPeer::SKICENTER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->open = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->skicenter_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = LiftPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Lift object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LiftPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LiftPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LiftPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LiftPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(LiftPeer::OPEN)) {
            $modifiedColumns[':p' . $index++]  = '`open`';
        }
        if ($this->isColumnModified(LiftPeer::SKICENTER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`skicenter_id`';
        }

        $sql = sprintf(
            'INSERT INTO `lift` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LiftPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LiftPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Lift'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Lift'][$this->getPrimaryKey()] = true;
        $keys = LiftPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
            $keys[1] => $this->getname(),
            $keys[2] => $this->getopen(),
            $keys[3] => $this->getskicenter_id(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setskicenter_id($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LiftPeer::ID)) $criteria->add(LiftPeer::ID, $this->id);
        if ($this->isColumnModified(LiftPeer::NAME)) $criteria->add(LiftPeer::NAME, $this->name);
        if ($this->isColumnModified(LiftPeer::OPEN)) $criteria->add(LiftPeer::OPEN, $this->open);
        if ($this->isColumnModified(LiftPeer::SKICENTER_ID)) $criteria->add(LiftPeer::SKICENTER_ID, $this->skicenter_id);
    ...
    {
        $criteria = new Criteria(LiftPeer::DATABASE_NAME);
        $criteria->add(LiftPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Lift (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Lift Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(LiftPeer::DEFAULT_STRING_FORMAT);
    }
