 ...
 * @method TrackQuery orderByskicenter_id($order = Criteria::ASC) Order by the skicenter_id column
 * @method TrackQuery orderBydifficulty($order = Criteria::ASC) Order by the difficulty column
 * @method TrackQuery orderBylength($order = Criteria::ASC) Order by the length column
 * @method TrackQuery orderByopen($order = Criteria::ASC) Order by the open column
 *
 * @method TrackQuery groupByid() Group by the id column
 * @method TrackQuery groupByname() Group by the name column
 * @method TrackQuery groupByskicenter_id() Group by the skicenter_id column
 * @method TrackQuery groupBydifficulty() Group by the difficulty column
 * @method TrackQuery groupBylength() Group by the length column
 * @method TrackQuery groupByopen() Group by the open column
 *
 ...
 *
 * @method TrackQuery leftJoinSkiCenter($relationAlias = null) Adds a LEFT JOIN clause to the query using the SkiCenter relation
 * @method TrackQuery rightJoinSkiCenter($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SkiCenter relation
 * @method TrackQuery innerJoinSkiCenter($relationAlias = null) Adds a INNER JOIN clause to the query using the SkiCenter relation
 *
 ...
 * @method Track findOneByskicenter_id(int $skicenter_id) Return the first Track filtered by the skicenter_id column
 * @method Track findOneBydifficulty(string $difficulty) Return the first Track filtered by the difficulty column
 * @method Track findOneBylength(int $length) Return the first Track filtered by the length column
 * @method Track findOneByopen(int $open) Return the first Track filtered by the open column
 *
 ...
 * @method array findByskicenter_id(int $skicenter_id) Return Track objects filtered by the skicenter_id column
 * @method array findBydifficulty(string $difficulty) Return Track objects filtered by the difficulty column
 * @method array findBylength(int $length) Return Track objects filtered by the length column
 * @method array findByopen(int $open) Return Track objects filtered by the open column
 *
...
abstract class BaseTrackQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `name`, `skicenter_id`, `difficulty`, `length`, `open` FROM `track` WHERE `id` = :p0';
        try {
    ...
    public function filterByskicenter_id($skicenter_id = null, $comparison = null)
    {
        if (is_array($skicenter_id)) {
            ...
            if (isset($skicenter_id['min'])) {
                $this->addUsingAlias(TrackPeer::SKICENTER_ID, $skicenter_id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($skicenter_id['max'])) {
                $this->addUsingAlias(TrackPeer::SKICENTER_ID, $skicenter_id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TrackPeer::SKICENTER_ID, $skicenter_id, $comparison);
    }
     ...
     * $query->filterBydifficulty('%fooValue%'); // WHERE difficulty LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterBydifficulty($difficulty = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($difficulty)) {
                $comparison = Criteria::IN;
            } elseif (preg_match('/[\%\*]/', $difficulty)) {
                $difficulty = str_replace('*', '%', $difficulty);
                $comparison = Criteria::LIKE;
            }
        }

        return $this->addUsingAlias(TrackPeer::DIFFICULTY, $difficulty, $comparison);
    }
    ...
    public function filterBylength($length = null, $comparison = null)
    {
        if (is_array($length)) {
            $useMinMax = false;
            if (isset($length['min'])) {
                $this->addUsingAlias(TrackPeer::LENGTH, $length['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($length['max'])) {
                $this->addUsingAlias(TrackPeer::LENGTH, $length['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TrackPeer::LENGTH, $length, $comparison);
    }
    ...
    public function filterByopen($open = null, $comparison = null)
    {
        if (is_array($open)) {
            $useMinMax = false;
            if (isset($open['min'])) {
                $this->addUsingAlias(TrackPeer::OPEN, $open['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($open['max'])) {
                $this->addUsingAlias(TrackPeer::OPEN, $open['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TrackPeer::OPEN, $open, $comparison);
    }
    ...
    public function filterBySkiCenter($skiCenter, $comparison = null)
    {
        if ($skiCenter instanceof SkiCenter) {
            return $this
                ->addUsingAlias(TrackPeer::SKICENTER_ID, $skiCenter->getid(), $comparison);
            ...
            return $this
                ->addUsingAlias(TrackPeer::SKICENTER_ID, $skiCenter->toKeyValue('PrimaryKey', 'id'), $comparison);
        } else {
