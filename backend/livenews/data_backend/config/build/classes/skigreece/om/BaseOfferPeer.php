...
abstract class BaseOfferPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('id', 'urlimage', 'comments', 'skicenter_id', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'urlimage', 'comments', 'skicenter_id', ),
        BasePeer::TYPE_COLNAME => array (OfferPeer::ID, OfferPeer::URLIMAGE, OfferPeer::COMMENTS, OfferPeer::SKICENTER_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'URLIMAGE', 'COMMENTS', 'SKICENTER_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'urlimage', 'comments', 'skicenter_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('id' => 0, 'urlimage' => 1, 'comments' => 2, 'skicenter_id' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'urlimage' => 1, 'comments' => 2, 'skicenter_id' => 3, ),
        BasePeer::TYPE_COLNAME => array (OfferPeer::ID => 0, OfferPeer::URLIMAGE => 1, OfferPeer::COMMENTS => 2, OfferPeer::SKICENTER_ID => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'URLIMAGE' => 1, 'COMMENTS' => 2, 'SKICENTER_ID' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'urlimage' => 1, 'comments' => 2, 'skicenter_id' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OfferPeer::URLIMAGE);
            $criteria->addSelectColumn(OfferPeer::COMMENTS);
            $criteria->addSelectColumn(OfferPeer::SKICENTER_ID);
        } else {
    ...
    public static function doCountJoinSkiCenter(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OfferPeer::SKICENTER_ID, SkiCenterPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Offer objects pre-filled with their SkiCenter objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinSkiCenter(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Offer) to $obj2 (SkiCenter)
                $obj2->addOffer($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Offer) to the collection in $obj2 (SkiCenter)
                $obj2->addOffer($obj1);
