...
abstract class BaseOffer extends BaseObject implements Persistent
{
    ...
    public function seturlimage($v)
    {
        ...
        if ($this->urlimage !== $v) {
            $this->urlimage = $v;
            $this->modifiedColumns[] = OfferPeer::URLIMAGE;
        }
    ...
    public function setcomments($v)
    {
        ...
        if ($this->comments !== $v) {
            $this->comments = $v;
            $this->modifiedColumns[] = OfferPeer::COMMENTS;
        }
    ...
    public function setskicenter_id($v)
    {
        ...
        if ($this->skicenter_id !== $v) {
            $this->skicenter_id = $v;
            $this->modifiedColumns[] = OfferPeer::SKICENTER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->urlimage = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 4; // 4 = OfferPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OfferPeer::URLIMAGE)) {
            $modifiedColumns[':p' . $index++]  = '`urlimage`';
        }
        if ($this->isColumnModified(OfferPeer::COMMENTS)) {
            $modifiedColumns[':p' . $index++]  = '`comments`';
        }
        if ($this->isColumnModified(OfferPeer::SKICENTER_ID)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->seturlimage($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OfferPeer::URLIMAGE)) $criteria->add(OfferPeer::URLIMAGE, $this->urlimage);
        if ($this->isColumnModified(OfferPeer::COMMENTS)) $criteria->add(OfferPeer::COMMENTS, $this->comments);
        if ($this->isColumnModified(OfferPeer::SKICENTER_ID)) $criteria->add(OfferPeer::SKICENTER_ID, $this->skicenter_id);
    ...
    public function getSkiCenter(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSkiCenter === null && ($this->skicenter_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSkiCenter->addOffers($this);
             */
        }
