...
abstract class BaseTrackPeer
{
    ...
    const SKICENTER_ID = 'track.skicenter_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('id', 'name', 'skicenter_id', 'difficulty', 'length', 'open', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'skicenter_id', 'difficulty', 'length', 'open', ),
        BasePeer::TYPE_COLNAME => array (TrackPeer::ID, TrackPeer::NAME, TrackPeer::SKICENTER_ID, TrackPeer::DIFFICULTY, TrackPeer::LENGTH, TrackPeer::OPEN, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'SKICENTER_ID', 'DIFFICULTY', 'LENGTH', 'OPEN', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'skicenter_id', 'difficulty', 'length', 'open', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('id' => 0, 'name' => 1, 'skicenter_id' => 2, 'difficulty' => 3, 'length' => 4, 'open' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'skicenter_id' => 2, 'difficulty' => 3, 'length' => 4, 'open' => 5, ),
        BasePeer::TYPE_COLNAME => array (TrackPeer::ID => 0, TrackPeer::NAME => 1, TrackPeer::SKICENTER_ID => 2, TrackPeer::DIFFICULTY => 3, TrackPeer::LENGTH => 4, TrackPeer::OPEN => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'SKICENTER_ID' => 2, 'DIFFICULTY' => 3, 'LENGTH' => 4, 'OPEN' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'skicenter_id' => 2, 'difficulty' => 3, 'length' => 4, 'open' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TrackPeer::SKICENTER_ID);
            $criteria->addSelectColumn(TrackPeer::DIFFICULTY);
            $criteria->addSelectColumn(TrackPeer::LENGTH);
            $criteria->addSelectColumn(TrackPeer::OPEN);
        } else {
    ...
    public static function doCountJoinSkiCenter(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(TrackPeer::SKICENTER_ID, SkiCenterPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Track objects pre-filled with their SkiCenter objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinSkiCenter(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Track) to $obj2 (SkiCenter)
                $obj2->addTrack($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Track) to the collection in $obj2 (SkiCenter)
                $obj2->addTrack($obj1);
