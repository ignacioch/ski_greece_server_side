...
/**
 * Base class that represents a row from the 'camera' table.
 *
 *
 *
 * @package    propel.generator.skigreece.om
 */
abstract class BaseCamera extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
     ...
     * @return Camera The current object (for fluent API support)
     */
    public function setid($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CameraPeer::ID;
        }
    ...
    public function seturl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[] = CameraPeer::URL;
        }
    ...
    public function setskicenter_id($v)
    {
        ...
        if ($this->skicenter_id !== $v) {
            $this->skicenter_id = $v;
            $this->modifiedColumns[] = CameraPeer::SKICENTER_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = CameraPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Camera object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CameraPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CameraQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CameraPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CameraPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CameraPeer::URL)) {
            $modifiedColumns[':p' . $index++]  = '`url`';
        }
        if ($this->isColumnModified(CameraPeer::SKICENTER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`skicenter_id`';
        }

        $sql = sprintf(
            'INSERT INTO `camera` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CameraPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CameraPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Camera'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Camera'][$this->getPrimaryKey()] = true;
        $keys = CameraPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getid(),
            $keys[1] => $this->geturl(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CameraPeer::ID)) $criteria->add(CameraPeer::ID, $this->id);
        if ($this->isColumnModified(CameraPeer::URL)) $criteria->add(CameraPeer::URL, $this->url);
        if ($this->isColumnModified(CameraPeer::SKICENTER_ID)) $criteria->add(CameraPeer::SKICENTER_ID, $this->skicenter_id);
    ...
    {
        $criteria = new Criteria(CameraPeer::DATABASE_NAME);
        $criteria->add(CameraPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Camera (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Camera Clone of current object.
     * @throws PropelException
     */
    ...
    public function getSkiCenter(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSkiCenter === null && ($this->skicenter_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aSkiCenter->addCameras($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CameraPeer::DEFAULT_STRING_FORMAT);
    }
